...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 OLMP"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 OLMP"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 OLMP"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 OLMP"));
