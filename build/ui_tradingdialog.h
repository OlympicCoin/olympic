...
public:
    ...
    QLabel *label_11;
    QLabel *OLMPBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *OLMPAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *OLMPPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        OLMPAvailableLabel = new QLabel(BuyTab);
        OLMPAvailableLabel->setObjectName(QStringLiteral("OLMPAvailableLabel"));
        QPalette palette1;
        ...
        OLMPAvailableLabel->setPalette(palette1);
        OLMPAvailableLabel->setFont(font3);
        OLMPAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(OLMPAvailableLabel);

        labelOLMP = new QLabel(BuyTab);
        labelOLMP->setObjectName(QStringLiteral("labelOLMP"));
        labelOLMP->setFont(font3);

        horizontalLayout->addWidget(labelOLMP);
        ...
        UnitsInputOLMP = new QLineEdit(BuyTab);
        UnitsInputOLMP->setObjectName(QStringLiteral("UnitsInputOLMP"));
        UnitsInputOLMP->setMinimumSize(QSize(0, 0));
        UnitsInputOLMP->setFont(font5);

        gridLayout_6->addWidget(UnitsInputOLMP, 4, 9, 1, 1);
        ...
        BuyOLMP = new QPushButton(BuyTab);
        BuyOLMP->setObjectName(QStringLiteral("BuyOLMP"));

        gridLayout_6->addWidget(BuyOLMP, 7, 3, 1, 1);

        SellOLMPBTN = new QPushButton(BuyTab);
        SellOLMPBTN->setObjectName(QStringLiteral("SellOLMPBTN"));

        gridLayout_6->addWidget(SellOLMPBTN, 7, 9, 1, 1);
        ...
        OLMPDemand = new QLabel(BuyTab);
        OLMPDemand->setObjectName(QStringLiteral("OLMPDemand"));
        QFont font6;
        font6.setPointSize(8);
        OLMPDemand->setFont(font6);
        OLMPDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(OLMPDemand, 0, 1, 1, 5);

        OLMPSupply = new QLabel(BuyTab);
        OLMPSupply->setObjectName(QStringLiteral("OLMPSupply"));
        OLMPSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(OLMPSupply, 0, 9, 1, 3);
        ...
        BittrexOLMPLabel = new QLabel(tab);
        BittrexOLMPLabel->setObjectName(QStringLiteral("BittrexOLMPLabel"));
        QPalette palette7;
        ...
        BittrexOLMPLabel->setPalette(palette7);
        BittrexOLMPLabel->setFont(font7);
        BittrexOLMPLabel->setAutoFillBackground(false);
        BittrexOLMPLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexOLMPLabel);
        ...
        OLMPBalanceLabel = new QLabel(BalanceTab);
        OLMPBalanceLabel->setObjectName(QStringLiteral("OLMPBalanceLabel"));
        OLMPBalanceLabel->setFont(font4);
        OLMPBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OLMPBalanceLabel, 0, 3, 1, 1);
        ...
        OLMPAvailableLabel_2 = new QLabel(BalanceTab);
        OLMPAvailableLabel_2->setObjectName(QStringLiteral("OLMPAvailableLabel_2"));
        OLMPAvailableLabel_2->setFont(font4);
        OLMPAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OLMPAvailableLabel_2, 1, 3, 1, 1);
        ...
        OLMPPendingLabel = new QLabel(BalanceTab);
        OLMPPendingLabel->setObjectName(QStringLiteral("OLMPPendingLabel"));
        OLMPPendingLabel->setFont(font4);
        OLMPPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(OLMPPendingLabel, 2, 3, 1, 1);
        ...
        OLMPBalanceLabel->raise();
        OLMPAvailableLabel_2->raise();
        OLMPPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "OLMP Available:", 0));
        OLMPAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelOLMP->setText(QApplication::translate("tradingDialog", " OLMP", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "OLMP", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "OLMP", 0));
        ...
        BuyOLMP->setText(QApplication::translate("tradingDialog", "Buy OLMP", 0));
        SellOLMPBTN->setText(QApplication::translate("tradingDialog", "Sell OLMP", 0));
        ...
        OLMPDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 OLMP", 0));
        OLMPSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 OLMP", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in OLMP:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "OLMP", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "OLMP Balance:", 0));
        BittrexOLMPLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "OLMP", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "OLMP Balance:", 0));
        OLMPBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "OLMP Available:", 0));
        OLMPAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "OLMP Pending:", 0));
        OLMPPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate OLMP Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw OLMP:", 0));
