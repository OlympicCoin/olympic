...
private slots:
    ...
    QString BuyOLMP(QString OrderType, double Quantity, double Rate);
    QString SellOLMP(QString OrderType, double Quantity, double Rate);
