...
int nAnonymizeOlympicAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Olympic
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Olympic
    // Mac: ~/Library/Application Support/Olympic
    // Unix: ~/.Olympic
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Olympic";
#else
    fs::path pathRet;
