#############################################################################
# Makefile for building: Olympic-qt
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  olympic-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake USE_UPNP=0 -o Makefile olympic-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DQT_DISABLE_DEPRECATED_BEFORE=0 -DBOOST_VARIANT_USE_RELAXED_GET_BY_DEFAULT -DUSE_DBUS -DHAVE_BUILD_INFO -DUSE_UPNP=0 -DMINIUPNP_STATICLIB -DSTATICLIB -DLINUX -DQT_NO_DEBUG -DQT_PRINTSUPPORT_LIB -DQT_WIDGETS_LIB -DQT_DBUS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
Makefile: olympic-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_UPNP=0 -o Makefile olympic-qt.pro
...
/home/home/olympic/src/leveldb/libleveldb.a: FORCE
	cd /home/home/olympic/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/home/olympic/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /home/home/olympic/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/home/home/olympic/build/build.h: FORCE
	cd /home/home/olympic; /bin/sh share/genbuild.sh /home/home/olympic/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/Olympic-16.png \
		...
		src/qt/res/icons/Olympic-80.png \
